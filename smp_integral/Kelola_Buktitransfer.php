        ...
        <table>
            <thead >
                <tr align="center">
                    ...
                    <th rowspan="2">Nomer Rekening</th>          
                </tr>
            </thead>
            <tbody>
            <tr>                      
                      <td colspan="2">TOTAL KESELURUHAN</td>
                      <td colspan="2">12234345</span></td>
                </tr>
    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
          <div class="col-sm-12 col-lg-12 ">
            ...
            <a href="TambahData_BuktitransferSMP.php" class="btn btn-primary mb-4"><i class="nav-icon fa fa-cart-plus"></i> Tambah Transaksi</a>
