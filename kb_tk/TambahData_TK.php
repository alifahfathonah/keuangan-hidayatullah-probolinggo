<?php
    ...
    $kodetambahTK = kodetambahTK();

?>

<div class="container-fluid">
    <h2 align="center" class="pt-3 pb-3">Input Penerimaan KB - TK Al - Ihsan</h2>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control" name="id_data_input" value="<?=$kodetambahTK?>" readonly>
                    </div>  
                    ...
                    <label for="">Kategori  </label>
                        <select name="id_kategori" class="form-control select-dropdown" required>
                            ...
                            $query = mysqli_query($koneksi, "SELECT * FROM db_kategori WHERE id_usaha = 'DTU001'");
...
<?php
    ...
    if (isset($_POST['submit'])) {
            if (tambahdataTK($_POST) > 0){
                echo "
                <script>
                alert('Pemasukan Sudah Berhasil Di Tambah');
                document.location.href = 'KelolaPelaporan_TK.php';
                </script>
                ";
            } else {
                echo "
                ...
                // document.location.href = 'TambahData_TK.php';            
                </script>
                ";
                echo("<br>");
