...
<div class="container-fluid">
    <h2 align="center" class="pt-3 pb-3">Edit Data Laporan KB - TK Al - Ihsan</h2>
...
<?php
    ...
    if (isset($_POST['submit'])) {
        if (editdatalaporan($_POST) > 0){
            ...
            document.location.href = 'EditData_TK.php';
            </script>
            ";
        } else {
            echo "
            ...
            // document.location.href = 'EditData_laporanTK.php';            
            </script>
            ";
            echo("<br>");
