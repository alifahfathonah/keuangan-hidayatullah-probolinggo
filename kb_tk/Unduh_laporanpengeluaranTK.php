<?php
   ...
   header("content-disposition: attachment;filename=Data Laporan Pengeluaran KB - TK Al - Ihsan".$dat.".xls");
   ...
   include "../kb_tk/fungsi.php";
    ...
    ini_set('log_errors','On');
      ...
      WHERE id_usaha = 'DTU001'AND id_pp = 2
      ");
      ...
      INNER JOIN db_bulan b ON a.id_bulan = b.id_bulan WHERE id_usaha = 'DTU001' ORDER BY id_data_output DESC LIMIT 1");
?>
...
<div class="container-fluid">
    ...
    <p><center>DATA PENGELUARAN KB - TK Al - Ihsan</center>    
