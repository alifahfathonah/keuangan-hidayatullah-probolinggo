<?php
   ...
   include "../sd_integral/fungsi.php";
    ...
    ini_set('log_errors','On');
      ...
      WHERE id_usaha = 'DTU003'AND id_pp = 2
      ");
      ...
      WHERE a.id_usaha = 'DTU003' AND a.id_pp = 2
      
      GROUP BY b.nama_pengeluaran ASC"
      ); 

      $data_terakhir = query("SELECT b.kd_nama_bulan FROM db_data_output a 
      INNER JOIN db_bulan b ON a.id_bulan = b.id_bulan WHERE id_usaha = 'DTU003' ORDER BY id_data_output DESC LIMIT 1");
?>
...
<div class="container-fluid">
    ...
    <p><center>DATA PENGELUARAN SD INTEGRAL</center>    
