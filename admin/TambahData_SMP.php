<?php
    ...
    $linklokasi3 = "TambahData_SMP.php";
                ...
                <div class="card-body">
                    ...
                    <label for="">Kategori  </label>
                        <select name="id_kategori" class="form-control select-dropdown" required>
                            ...
                            $query = mysqli_query($koneksi, "SELECT * FROM db_kategori WHERE id_usaha = 'DTU004'");
...
<?php
    ...
    if (isset($_POST['submit'])) {
            if (tambahdataSMP($_POST) > 0){
                echo "
                <script>
                alert('Pemasukan Sudah Berhasil Di Tambah');
                document.location.href = 'KelolaPelaporan_SMP.php';
                </script>
                ";
            } else {
                echo "
                ...
                // document.location.href = 'TambahData_SMP.php';            
                </script>
                ";
                echo("<br>");
