  ...
  <div class="container-fluid">
      <div class="col-12 col-s-12">
          <h2 align="center">Transaksi Pemasukan Mitra BMH</h2>
      ...
      <div class="row justify-content-center">
          <div class="col-sm-12 col-lg-12 ">
              <a href="EditData_BMH.php" class="btn btn-primary mb-4"><i class="nav-icon fa fa-database"></i> Detail Transaksi</a>
              <a href="Unduh_laporanBMH.php" class="btn btn-primary mb-4"><i class="nav-icon fa fa-print"></i> Unduh Laporan</a>
              <br>
