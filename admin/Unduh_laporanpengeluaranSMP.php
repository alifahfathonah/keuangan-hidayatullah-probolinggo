<?php
   ...
   header("content-disposition: attachment;filename=Data Laporan Pengeluaran SD Integral ".$dat.".xls");
   ...
   include "../admin/fungsi.php";
    ...
    ini_set('log_errors','On');
      ...
      WHERE id_usaha = 'DTU004'AND id_pp = 2
      ");
      ...
      WHERE a.id_usaha = 'DTU004' AND a.id_pp = 2
      
      GROUP BY b.nama_pengeluaran ASC"
      ); 

      $data_terakhir = query("SELECT b.kd_nama_bulan FROM db_data_output a 
      INNER JOIN db_bulan b ON a.id_bulan = b.id_bulan WHERE id_usaha = 'DTU004' ORDER BY id_data_output DESC LIMIT 1");
?>

    <?php

        $hasil1=mysqli_query($koneksi,"SELECT * FROM db_data_output where id_usaha = 'DTU003'");
...
<div class="container-fluid">
    ...
    <p><center>DATA PENGELUARAN SMP INTEGRAL</center>    
