<?php
   ...
   header("content-disposition: attachment;filename=Data Laporan Pemasukan SMP Integral ".$dat.".xls");
   ...
   include "../admin/fungsi.php";
    ...
    ini_set('log_errors','On');
      ...
      $hasil1=mysqli_query($koneksi,"SELECT b.kd_nama_bulan FROM db_data_input a 
      INNER JOIN db_bulan b ON a.id_bulan = b.id_bulan where id_usaha = 'DTU004'
      GROUP BY b.kd_nama_bulan");
      while ($jumlah1=mysqli_fetch_array($hasil1)){
      $arrayhasil1[] = $jumlah1['kd_nama_bulan'];
      }
      $jumlahhasil1 = array_sum($arrayhasil1);
      

      $db_data  = query("SELECT a.id_data_input, c.kd_nama_bulan, b.nama_kategori, SUM(a.kd_jumlah) AS totalkeseluruhan,
      ...
      INNER JOIN db_bulan b ON a.id_bulan = b.id_bulan WHERE id_usaha = 'DTU004' ORDER BY id_data_input DESC LIMIT 1");
?>
...
<div class="container-fluid">
    ...
    <p><center>DATA PEMASUKAN SMP INTEGRAL</center>
