<?php
   ...
   header("content-disposition: attachment;filename=Data Pemasukan Yayasan Al - Ihsan ".$dat.".xls");
...
<div class="container-fluid">
    ...
    <p><center><b>LAPORAN PEMASUKAN DAN PENGELUARAN<b></center>
    <center><b>YAYASAN AL - IHSAN HIDAYATULLAH PROBOLINGGO</b></center></p>
    ...
    <table class="table table-striped table-hover table-bordered table-align-middle" id="data">
                    ...
                    <tr align="center">
                         <td colspan="2"><b>Unit Usaha</b></th>
                          <td colspan="2"><b>Pemasukan</b></th>  
                          <td colspan="2"><b>Pengeluaran</b></th>
                          <td colspan="2"><b>Dana Saving</b></th>
                  ...
                  <?php
                      ...
                      <td colspan="2">Rp. <?php echo number_format($pemasukanSMP,2,',','.') ?></span></td>
                      <td colspan="2">Rp. <?php echo number_format($pengeluaranSMP,2,',','.') ?></span></td>
                      <td colspan="2">Rp. <?php echo number_format($pemasukanSMP - $SMP75,2,',','.') ?></span></td>

                      <tr>
                      <td colspan="2">SD INTEGRAL :</td>
                      <td colspan="2">Rp. <?php echo number_format($pemasukanSD,2,',','.') ?></span></td>
                      <td colspan="2">Rp. <?php echo number_format($pengeluaranSD,2,',','.') ?></span></td>
                      <td colspan="2">Rp. <?php echo number_format($pemasukanSD - $SD75,2,',','.') ?></span></td>
                      <tr>
                      <td colspan="2">KB - TK AL - IHSAN :</td>
                      <td colspan="2">Rp. <?php echo number_format($pemasukanTK,2,',','.') ?></span></td>
                      <td colspan="2">Rp. <?php echo number_format($pengeluaranTK,2,',','.') ?></span></td>
                      <td colspan="2">Rp. <?php echo number_format($pemasukanTK - $TK75,2,',','.') ?></span></td>
                      <tr>
                      <td colspan="2">KB INTEGRAL :</td>
                      <td colspan="2">Rp. <?php echo number_format($pemasukanKB,2,',','.') ?></span></td>
                      <td colspan="2">Rp. <?php echo number_format($pengeluaranKB,2,',','.') ?></span></td>
                      <td colspan="2">Rp. <?php echo number_format($pemasukanKB - $KB75,2,',','.') ?></span></td>
                      <tr>
                      <td colspan="2">PESANTREN TAHFIDZ DH :</td>
                      <td colspan="2">Rp. <?php echo number_format($pemasukanPesantren,2,',','.') ?></span></td>
                      <td colspan="2">Rp. <?php echo number_format($pengeluaranPesantren,2,',','.') ?></span></td>
                      <td colspan="2">Rp. <?php echo number_format($pemasukanPesantren - $Pesantren75,2,',','.') ?></span></td>
                      <tr>
                      <td colspan="2">MITRA ZAKAT :</td>
                      <td colspan="2">Rp. <?php echo number_format($pemasukanMZ,2,',','.') ?></span></td>
                      <td colspan="2">Rp. <?php echo number_format($pengeluaranMZ,2,',','.') ?></span></td>
                      <td colspan="2">Rp. <?php echo number_format($pemasukanMZ - $MZ75,2,',','.') ?></span></td>
                      <tr colspan="2">
                      <td colspan="2">MITRA BMH :</td>
                      <td colspan="2">Rp. <?php echo number_format($pemasukanBMH,2,',','.') ?></span></td>
                      <td colspan="2">Rp. <?php echo number_format($pengeluaranBMH,2,',','.') ?></span></td>
                      <td colspan="2"> - </span></td>
                      <tr>
                      <td colspan="2">DANA SAVING :</b></td>
                      <td colspan="2">Rp. <?php echo number_format($totalA,2,',','.') ?></span></td>
                      <td colspan="2">Rp. <?php echo number_format($pengeluaranDana,2,',','.') ?></span></td>
                      <td colspan="2">Rp. <?php echo number_format($pemasukanSMP - $SMP75 + $pemasukanSD - $SD75 + $pemasukanTK - $TK75 + $pemasukanKB - $KB75 + $pemasukanPesantren - $Pesantren75 + $pemasukanMZ - $MZ75,2,',','.') ?></span></td>
                      <tr>                      
                      <!-- <td colspan="4"><b>TOTAL PEMASUKAN : </b><b>Rp. <?php echo number_format($pemasukanTOTAL,2,',','.') ?></b></span></td>
                      <td colspan="4"><b>SALDO AKHIR UNIT USAHA : </b><b>Rp. <?php echo number_format($pengeluaranDana50,2,',','.') ?></b></span></td>         
                      <tr>
                      <td colspan="4"><b>TOTAL PENGELUARAN : </b><b>Rp. <?php echo number_format($pengeluaranTOTAL,2,',','.') ?></b></span></td>
                      <td colspan="4"><b>SALDO AKHIR YAYASAN : </b><b>Rp. <?php echo number_format($totalA,2,',','.') ?></b></span></td>          -->

                      <td colspan="4"><b>TOTAL PEMASUKAN UNIT USAHA: </b><b>Rp. <?php echo number_format($pemasukanTOTAL,2,',','.') ?></b></span></td>
                      <td colspan="4"><b>TOTAL PEMASUKAN YAYASAN : </b><b>Rp. <?php echo number_format(($pemasukanSMP - $SMP75 + $pemasukanSD - $SD75 + $pemasukanTK - $TK75 + $pemasukanKB - $KB75 + $pemasukanPesantren - $Pesantren75 + $pemasukanMZ - $MZ75) + $pemasukanyayasan,2,',','.') ?></b></span></td>     
                      <tr>
                      <td colspan="4"><b>TOTAL PENGELUARAN UNIT USAHA : </b><b>Rp. <?php echo number_format($pengeluaranTOTAL + ($pemasukanSMP - $SMP75 + $pemasukanSD - $SD75 + $pemasukanTK - $TK75 + $pemasukanKB - $KB75 + $pemasukanPesantren - $Pesantren75 + $pemasukanMZ - $MZ75 ) ,2,',','.') ?></b></span></td>
                      <td colspan="4"><b>TOTAL PENGELUARAN YAYASAN : </b><b>Rp. <?php echo number_format($pengeluaranDana ,2,',','.') ?></b></span></td>        
                      <tr>
                      <td colspan="4"><b>SALDO UNIT USAHA : </b><b>Rp. <?php echo number_format($pemasukanTOTAL - $pengeluaranunit - ($pemasukanSMP - $SMP75 + $pemasukanSD - $SD75 + $pemasukanTK - $TK75 + $pemasukanKB - $KB75 + $pemasukanPesantren - $Pesantren75 + $pemasukanMZ - $MZ75),2,',','.') ?></b></span></td>
                      <td colspan="4"><b>SALDO YAYASAN : </b><b>Rp. <?php echo number_format($totalA,2,',','.') ?></b></span></td> 
