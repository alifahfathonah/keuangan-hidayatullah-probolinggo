<?php
   ...
   header("content-disposition: attachment;filename=Data Laporan Pemasukan Mitra Zakat ".$dat.".xls");
   ...
   include "../admin/fungsi.php";
    ...
    ini_set('log_errors','On');
      ...
      WHERE a.id_pp = 1 AND a.id_usaha = 'DTU006'
      
      GROUP BY b.nama_kategori ASC"
      ); 

      $data_terakhir = query("SELECT b.kd_nama_bulan FROM db_data_input a 
      INNER JOIN db_bulan b ON a.id_bulan = b.id_bulan WHERE id_usaha = 'DTU006' ORDER BY id_data_input DESC LIMIT 1");
?>
...
<div class="container-fluid">
    ...
    <p><center>DATA PEMASUKAN MITRA ZAKAT</center>
