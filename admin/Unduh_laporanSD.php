<?php
   ...
   header("content-disposition: attachment;filename=Data Laporan Pemasukan SD Integral ".$dat.".xls");
   ...
   include "../admin/fungsi.php";
    ...
    ini_set('log_errors','On');
      ...
      INNER JOIN db_bulan b ON a.id_bulan = b.id_bulan WHERE id_usaha = 'DTU003' ORDER BY id_data_input DESC LIMIT 1");
?>
...
<div class="container-fluid">
    ...
    <p><center>DATA PEMASUKAN SD INTEGRAL</center>
