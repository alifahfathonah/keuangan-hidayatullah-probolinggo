                ...
                <div class="card-body">
                    ...
                    <label for="">Kategori  </label>
                        <select name="id_kategori" class="form-control select-dropdown" required>
                            ...
                            $query = mysqli_query($koneksi, "SELECT * FROM db_kategori WHERE id_usaha = 'DTU005'");
...
<?php
    ...
    if (isset($_POST['submit'])) {
            if (tambahdataPesantren($_POST) > 0){
                echo "
                <script>
                alert('Pemasukan Sudah Berhasil Di Tambah');
                document.location.href = 'KelolaPelaporan_Pesantren.php';
                </script>
                ";
            } else {
                echo "
                ...
                // document.location.href = 'TambahData_Pesantren.php';            
                </script>
                ";
                echo("<br>");
