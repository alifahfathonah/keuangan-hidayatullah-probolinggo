<?php
   ...
   header("content-disposition: attachment;filename=Data Laporan Pengeluaran YAYASAN AL - IHSAN".$dat.".xls");
   ...
   include "../admin/fungsi.php";
    ...
    ini_set('log_errors','On');
      ...
      $jumlah1 = mysqli_query($koneksi,"SELECT SUM(kd_jumlah)  from db_data_output 
      WHERE id_usaha = 'DTU005'AND id_pp = 2
      ");
      ...
      WHERE a.id_usaha = 'DTU008' AND a.id_pp = 2
      
      GROUP BY b.nama_pengeluaran ASC"
      ); 

      $data_terakhir = query("SELECT b.kd_nama_bulan FROM db_data_output a 
      INNER JOIN db_bulan b ON a.id_bulan = b.id_bulan WHERE id_usaha = 'DTU008' ORDER BY id_data_output DESC LIMIT 1");
?>

    <?php

        $hasil1=mysqli_query($koneksi,"SELECT * FROM db_data_output where id_usaha = 'DTU008'");
...
<div class="container-fluid">
    <p><center>DATA PENGELUARAN YAYASAN AL - IHSAN</center>
    <center>PESANTREN HIDAYATULLAH PROBOLINGGO</center></p>
