<?php
    ...
    $lokasi3 = "Tambah Data Yayasan Al - Ihsan";
    $linklokasi2 = "KelolaPelaporan_pengeluaranYayasan.php";
    $linklokasi3 = "";
    ...
    $hasil3=mysqli_query($koneksi,"SELECT SUM(sub_total) AS totalkeseluruhan FROM db_validasi where id_usaha = 'DTU008'");
...
<div class="container-fluid">
    <h2 align="center" class="pt-3 pb-3">Input Pengeluaran Yayasan Al - Ihsan</h2>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control" name="id_data_output" value="<?=$kodetambahpengeluaranYayasan?>" readonly>
                    ...
                    <!-- <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="sub_total" value="<?=$jumlahhasil3?>" hidden>
                    ...
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control" name="" value="Yayasan Al - Ihsan" readonly>
                    ...
                    <label for="">Kategori  </label>
                        <select name="id_kategori" class="form-control select-dropdown" required>
                            ...
                            $query = mysqli_query($koneksi, "SELECT * FROM db_kategori_pengeluaran WHERE id_usaha = 'DTU008'");
...
<?php
    ...
    if (isset($_POST['submit'])) {
        if ($_POST['kd_jumlah'] <= $_POST['max']) {
            if (tambahdatapengeluaranYayasan($_POST) > 0){
                echo "
                <script>
                ...
                document.location.href = 'TambahData_pengeluaranYayasan.php';         
                </script>
                ";
                echo("<br>");
