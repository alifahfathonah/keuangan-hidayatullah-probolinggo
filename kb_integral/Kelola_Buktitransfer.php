...
<br>
          ...
          <br>
              <table>
                  ...
                  <tbody>
                      ...
                      <td colspan="10">Rp. <?php echo number_format($pemasukanKB - $buktitransferKB,2,',','.') ?></span></td>
      ...
      <div class="row justify-content-center">
          <div class="col-sm-12 col-lg-12 ">
            ...
            <a href="TambahData_BuktitransferKB.php" class="btn btn-primary mb-4"><i class="nav-icon fa fa-cart-plus"></i> Tambah Transaksi</a>
