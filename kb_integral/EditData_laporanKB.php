<?php
    ...
    $lokasi3 = "Edit Data KB Integral";
    $linklokasi2 = "EditData_KB.php";
    $linklokasi3 = "";
    ...
    $id = $_GET['id'];
    $data = query("SELECT a.id_data_input, a.id_usaha, a.id_kategori, a.id_bulan, a.id_pp, a.kd_jumlah, a.kd_keterangan, a.gambar, b.kd_nama_usaha, c.nama_kategori, d.kd_nama_bulan
    ...
    WHERE a.id_pp = 1 AND id_data_input = '$id'")[0];   


?>
<div class="container-fluid">
    <h2 align="center" class="pt-3 pb-3">Edit Data Laporan KB Integral</h2>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="" value="<?=$data['nama_kategori']?>" readonly>
                    </div>  
                    <div class="col-md-6">
...
<?php
    ...
    if (isset($_POST['submit'])) {
        if (editdatalaporan($_POST) > 0){
            ...
            // document.location.href = 'EditData_laporanKB.php';            
            </script>
            ";
            echo("<br>");
