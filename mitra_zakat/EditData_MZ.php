<?php
    ...
    WHERE a.id_usaha = 'DTU006' AND  a.id_pp = 1
    ");
        ...
        <div class="col-sm-12 col-lg-12 ">
            ...
            <table class="table table-striped table-hover table-bordered table-align-middle" id="data">
                ...
                <tr align="center">
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="EditData_laporanMZ.php?id=<?=$data['id_data_input']?>"  class="btn btn-success"><i class="nav-icon fa fa-database"></i> Edit</a>
                            <a href="Deletedata_pemasukanMZ.php?id=<?=$data['id_data_input']?>" onclick="return confirm('Apakah anda ingin menghapus data ini ?')" class="btn btn-danger"><i class="nav-icon fa fa-trash"></i> Hapus</a>
                        </div>
                    </td>
                </tr>
                    <?php } ?>
