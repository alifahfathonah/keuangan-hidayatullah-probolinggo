<?php
    ...
    //tambah data
    $query = "INSERT INTO db_transfer VALUES ('$id_transfer', 'DTU006', '$id_bulan', '1', '$kd_jumlah', '$gambar', '$kd_keterangan')";
    $data = mysqli_query($koneksi, $query);
  ...
  function konfirmasitk($data){
    ...
    function tambahValidasiBMH($data){
        ...
        $query1 = "INSERT INTO db_validasi VALUES ('$id_validasi', 'DTU007', '$sisa', '$sisaanggaran')";
